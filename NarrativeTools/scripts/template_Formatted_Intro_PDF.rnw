...
for(t in taxa){
  if(t=="AM"){
    ...
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{IMGAS }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IIODO"){
    ...
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{IICOL }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
else if(t=="CGH"|t=="O"){
