...
\begin{wrapfigure}{R}{.5\textwidth}
 \fbox{\begin{minipage}{\dimexpr\linewidth-2\fboxrule-2\fboxsep}
    ...
    \noindent The information depicted in this report is also incorporated into the \textbf{Pennsylvania Conservation Explorer} (aka "Explorer"), a web-based interactive application. Explorer allows users to access conservation planning information—users can see locations of natural heritage areas, protected lands and high quality streams. Conservation reports can downloaded for use in local planning or project specific assessment. Through Explorer, users may:
    \begin{enumerate}
    ...
    \end{enumerate}
    \noindent While the first two uses are freely available to anyone interested in exploring the data, the third use is a component of a formal procedure for granting permits to projects, and requires users to log in. Explorer makes available a variety of online video tutorials, supporting 37
materials, and other resources to aid users in maximizing their use of this tool. \\
...
Every stream, tributary, and river has an associated watershed, with small watersheds merging to become larger watersheds. Watersheds can be classified at large scales, like that of the ____ River, or small scales, like that of the ____, but all land is part of a watershed. % Susquehanna Raystown Branch of the Juniata River
