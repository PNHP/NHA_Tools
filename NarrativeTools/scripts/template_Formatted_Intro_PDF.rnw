...
% % \begin{figure}[h]
% %\centering
% \includegraphics[width=0.50\textwidth]{fieldwork}
%  \caption{\textit{Fieldwork like this is what we do...}}
%  \label{fig:NHAfieldwork}
% % \end{figure}
% \end{wrapfigure}
...
Due to a combination of sensitivity issues, some species have created challenges for being incorporatedinto meaningful conservation planning products, namely Natural Heritage Areas. These issues are primarily a combination of: \begin{itemize}
