...
\noindent Federally listed species are under the jurisdiction of the US Fish and Wildlife Service and have the status definition as described in Table~\ref{tab:statusFed}. 
