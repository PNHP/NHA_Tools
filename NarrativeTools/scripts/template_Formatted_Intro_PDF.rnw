...
for(t in taxa){
  if(t=="AM"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Mammals }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="AB"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Birds }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="AA"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Amphibians }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="AR"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Reptiles }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="AF"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Fish }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IMBIV"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Freshwater Mussels }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="P"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Plants }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="N"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Mosses, Liverworts, and Hornworts }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IMGAS"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Snails and Slugs }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IIODO"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Dragonflies and Damselflies }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IILEP"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Butterflies }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IILEY"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Moths }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IIPLE"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Stoneflies }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else if(t=="IITRI"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Caddisflies }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }  
  else if(t=="ICMAL"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Crustaceans }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
   else if(t=="IICOL02"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Tiger Beetles }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  } 
  else if(t=="IICOL"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Other Beetles }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
else if(t=="CGH"|t=="O"){
    cat(paste0(' \\midrule \\multicolumn{4}{l}{','{\\textbf{Communities and Natural Features }}',"\\includegraphics[width=0.15in]{",taxaicon[which(taxaicon$ELEMENT_TYPE==t),"icon"],"}}", '\\\\ \\midrule \n'))
  }
  else{
    cat(paste0(' \\midrule \\multicolumn{4}{l}{',t,'}', '\\\\ \n'))
  }
  for(i in 1:nrow(speciestable)){
    if(speciestable$ELEMENT_TYPE[i] == t){
      ...
      if(is.na(speciestable$SPROT[i]) & is.na(speciestable$PBSSTATUS[i])){
        statusstring <- ""
      } else if(is.na(speciestable$SPROT[i])){
        statusstring <- paste("(",speciestable$PBSSTATUS[i],")",sep="")
      } else if(!is.na(speciestable$SPROT[i]) & is.na(speciestable$PBSSTATUS[i])){
        statusstring <- paste(speciestable$SPROT[i], sep="")
      } else {
        statusstring <- paste(speciestable$SPROT[i]," (",speciestable$PBSSTATUS[i],")",sep="")
      }
      
      # make the row
      cat(paste0(speciesstring , " & ", speciestable$GRANK[i], " & ", speciestable$SRANK[i], " & ", statusstring ," \\\\") )
     }
  }
}  
@
