...
for(t in taxa){
  if(t=="AM"){
    cat(paste0('\\multicolumn{4}{l}{','{Mammals}}', '\\\\ \n'))
  }
  else if(t=="AB"){
    cat(paste0('\\multicolumn{4}{l}{','{Birds}}', '\\\\ \n'))
  }
  else if(t=="AAAA"){
    cat(paste0('\\multicolumn{4}{l}{','{Amphibians}}', '\\\\ \n'))
  }
  else if(t=="AR"){
    cat(paste0('\\multicolumn{4}{l}{','{Reptiles}}', '\\\\ \n'))
  }
  else if(t=="AF"){
    cat(paste0('\\multicolumn{4}{l}{','{Fish}}', '\\\\ \n'))
  }
  else if(t=="IMBIV"){
    cat(paste0('\\multicolumn{4}{l}{','{Freshwater Mussels}}', '\\\\ \n'))
  }
  else if(t=="P"){
    cat(paste0('\\multicolumn{4}{l}{','{Plants}}', '\\\\ \n'))
  }
  else if(t=="IMGAS"){
    cat(paste0('\\multicolumn{4}{l}{','{IMGAS}}', '\\\\ \n'))
  }
  else if(t=="IILEP"){
    cat(paste0('\\multicolumn{4}{l}{','{Butterflies and Moths}}', '\\\\ \n'))
  }
  else if(t=="CGH"){
    cat(paste0('\\multicolumn{4}{l}{','{CGH}}', '\\\\ \n'))
  }
  else if(t=="IICOL"){
    cat(paste0('\\multicolumn{4}{l}{','{IICOL}}', '\\\\ \n'))
  }
  else{
