...
All of the above species are mapped within an NHA, except for the following species:  \Sexpr{SUSN$SNAME}. Due to a combination of sensitivity issues, these species have created challenges for being incorporatedinto meaningful conservation planning products, namely Natural Heritage Areas
