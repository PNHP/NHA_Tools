...
\noindent The interaction of geology and climate creates landscape-scale patterns in critical ecological functions, including the regulation of biogeochemical cycles (water, carbon, and nitrogen), soil formation, and ultimately wildlife habitat formation \parencite{anderson_conserving_2010}. Nested within broad vegetation systems, defined by geology and climate, are recognizable natural communities, classified by the dominant species, habitat, and growth form. Boundaries between community types in the field are often gradual and indistinct. \\
