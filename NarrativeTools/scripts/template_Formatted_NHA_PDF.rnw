...
\end{itemize}
\medskip
\noindent We envision this NHA as one of the first steps for promoting conservation for the species of concern at the site. Many of these sites have multiple habitats present and conservation recommendations for the sites may occasionally conflict. PNHP partners are available for additional consultation and can point to additional resources.
